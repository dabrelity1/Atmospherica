...
public class WeatherPlatformRenderer<T extends BlockEntity> implements BlockEntityRenderer<T> {
   ...
   public AABB getRenderBoundingBox(T blockEntity) {
      return AABB.ofSize(blockEntity.getBlockPos().getCenter(), 512, 512, 512);
   }
   ...
   public static ResourceLocation getTexture(String path) {
      return (ResourceLocation)resLocMap.computeIfAbsent(path, k -> Atmospherica.getPath(String.format("textures/blockentity/%s.png", path)));
   }
