               ...
               for (Storm storm : weatherHandler.getStorms()) {
                  if (!storm.visualOnly) {
                     ...
                     if (storm.stormType == 2) {
                        ...
                        double temp117 = 1.0 - Mth.clamp(distance / storm.maxWidth, 0.0, 1.0);
                        float mult = (float)(temp117 * temp117 * temp117);
                        ...
                        double temp167 = Mth.clamp(storm.windspeed / 65.0F, 0.0F, 1.0F);
                        mult *= Mth.lerp((float)(temp167 * temp167), 1.0F, eye);
                     ...
                     if (storm.stormType == 1) {
                        ...
                        double temp205 = Mth.clamp(distance / ((float)ServerConfig.stormSize * 5.0F), 0.0, 1.0);
                        Vec2 off = Util.mulVec2(
                           fwd,
                           -((float)(temp205 * temp205))
