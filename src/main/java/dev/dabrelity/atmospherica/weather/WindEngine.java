               ...
               for (Storm storm : weatherHandler.getStorms()) {
                  if (!storm.visualOnly) {
                     ...
                     if (storm.stormType == 2) {
                        ...
                        float _distClamp3 = (float)(1.0 - Mth.clamp(distance / storm.maxWidth, 0.0, 1.0));
                        float mult = _distClamp3 * _distClamp3 * _distClamp3;
                        ...
                        float _wsClamp1 = Mth.clamp(storm.windspeed / 65.0F, 0.0F, 1.0F);
                        mult *= Mth.lerp(_wsClamp1 * _wsClamp1, 1.0F, eye);
                     ...
                     if (storm.stormType == 1) {
                        ...
                        float _distClamp4 = (float)Mth.clamp(distance / ((float)ServerConfig.stormSize * 5.0F), 0.0, 1.0);
                        Vec2 off = Util.mulVec2(
                           fwd,
                           -(_distClamp4 * _distClamp4)
