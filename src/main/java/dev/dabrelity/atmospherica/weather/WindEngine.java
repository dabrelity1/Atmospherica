               ...
               for (Storm storm : weatherHandler.getStorms()) {
                  if (!storm.visualOnly) {
                     ...
                     if (storm.stormType == 2) {
                        ...
                        float distClamp2 = (float)(1.0 - Mth.clamp(distance / storm.maxWidth, 0.0, 1.0));
                        float mult = distClamp2 * distClamp2 * distClamp2;
                        ...
                        float wsClamp = (float)Mth.clamp(storm.windspeed / 65.0F, 0.0F, 1.0F);
                     ...
                     if (storm.stormType == 1) {
                        ...
                        float distClamp = (float)Mth.clamp(distance / ((float)ServerConfig.stormSize * 5.0F), 0.0, 1.0);
