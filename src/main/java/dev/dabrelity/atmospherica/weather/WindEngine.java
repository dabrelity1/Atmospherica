               ...
               for (Storm storm : weatherHandler.getStorms()) {
                  if (!storm.visualOnly) {
                     ...
                     if (storm.stormType == 2) {
                        ...
                        float dClamp = (float)(1.0 - Mth.clamp(distance / storm.maxWidth, 0.0, 1.0));
                        float mult = dClamp * dClamp * dClamp;
                     ...
                     if (storm.stormType == 1) {
                        ...
                        float distRatio = Mth.clamp((float)distance / ((float)ServerConfig.stormSize * 5.0F), 0.0F, 1.0F);
