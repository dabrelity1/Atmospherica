package dev.dabrelity.atmospherica.particle.behavior;
...
public class ParticleBehavior {
   ...
   public void initParticleRain(EntityRotFX particle, int extraRenderCount) {
      ...
      particle.rotationYaw = Atmospherica.RANDOM.nextInt(360) - 180.0F;
   ...
   public void initParticleGroundSplash(EntityRotFX particle) {
      ...
      particle.setScale(0.2F + Atmospherica.RANDOM.nextFloat() * 0.05F);
      ...
      particle.setMotionY(Atmospherica.RANDOM.nextFloat() * 0.2F);
      particle.setMotionX((Atmospherica.RANDOM.nextFloat() - 0.5F) * 0.01F);
      particle.setMotionZ((Atmospherica.RANDOM.nextFloat() - 0.5F) * 0.01F);
      particle.setColor(this.vanillaRainRed, this.vanillaRainGreen, this.vanillaRainBlue);
   }
   ...
   public void initParticleSnow(EntityRotFX particle, int extraRenderCount, float windSpeed) {
      ...
      particle.setScale(0.19500001F + Atmospherica.RANDOM.nextFloat() * 0.05F);
      particle.setGravity(0.05F + Atmospherica.RANDOM.nextFloat() * 0.1F);
   ...
   public void initParticleHail(EntityRotFX particle) {
      ...
      particle.killWhenUnderCameraAtLeast = 5;
      particle.dontRenderUnderTopmostBlock = true;
      particle.rotationYaw = Atmospherica.RANDOM.nextInt(360);
      particle.rotationPitch = Atmospherica.RANDOM.nextInt(360);
      particle.fastLight = true;
      particle.slantParticleToWind = true;
      ...
      particle.setAlpha(0.0F);
      particle.rotationYaw = Atmospherica.RANDOM.nextInt(360) - 180;
      particle.setMotionY(-0.5);
