...
public class ColorTables {
   ...
   public static Color getIR(float val) {
      ...
      color = lerp(Mth.clamp(val / 100.0F, 0.0F, 1.0F), color, new Color(255, 255, 255));
      if (val > 100.0F) {
         color = lerp(Mth.clamp((val - 100.0F) / 20.0F, 0.0F, 1.0F), color, new Color(0, 16, 116));
         color = lerp(Mth.clamp((val - 120.0F) / 20.0F, 0.0F, 1.0F), color, new Color(105, 248, 251));
         color = lerp(Mth.clamp((val - 140.0F) / 10.0F, 0.0F, 1.0F), color, new Color(0, 253, 0));
         color = lerp(Mth.clamp((val - 150.0F) / 10.0F, 0.0F, 1.0F), color, new Color(253, 251, 71));
         color = lerp(Mth.clamp((val - 160.0F) / 20.0F, 0.0F, 1.0F), color, new Color(235, 55, 23));
         color = lerp(Mth.clamp((val - 180.0F) / 20.0F, 0.0F, 1.0F), color, new Color(110, 26, 10));
         color = lerp(Mth.clamp((val - 200.0F) / 20.0F, 0.0F, 1.0F), color, new Color(0, 0, 0));
         color = lerp(Mth.clamp((val - 220.0F) / 40.0F, 0.0F, 1.0F), color, new Color(255, 255, 255));
      }
