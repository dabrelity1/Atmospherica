...
public class ServerConfig {
   ...
   // Optimized: Use HashSet instead of ArrayList for O(1) lookups during high-frequency weather events
   ...
   // Optimized: Use HashSet instead of ArrayList for O(1) lookups during high-frequency rendering and ticking paths
